...
import { fetchEmployeeLogs } from "../../api/logApi";
...
const MyLoginLogs = () => {
  ...
  useEffect(() => {
    const loadLogs = async () => {
      try {
        const res = await fetchEmployeeLogs();
    ...
    return (
      <div className="min-h-[60vh] flex items-center justify-center">
        <div className="flex items-center gap-3 text-gray-500">
          ...
          <span>Loading your login activity...</span>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="p-6 lg:p-8 max-w-7xl mx-auto">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-gray-900">My Login Activity</h1>
        <p className="mt-1 text-sm text-gray-500">
          A record of recent login attempts and sessions
        </p>
      </div>
